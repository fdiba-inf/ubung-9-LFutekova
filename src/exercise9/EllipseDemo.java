...
public class EllipseDemo {
    public static void main(String[] args) {
        ...
        System.out.println("Ellipse 1: " + ellipse1.toString());
        System.out.println("Ellipse 2: " + ellipse2.toString());
        System.out.println("Ellipse 3: " + ellipse3.toString());
        System.out.println("Ellipse 4: " + ellipse4.toString());
